...
export interface components {
    schemas: {
        ...
        PostReportingOrlExternalRequestBody: {
            ...
            version: number;
            /** @enum {string} */
            requestOrigin: "PORTAL" | "WORKFLOW" | "ORCA_SECURITY" | "CSPM_SERVICE" | "COMMUNITY" | "SCM_PULL_REQUEST" | "SCM_SCHEDULE" | "HCL_TERRAFORM_RUN_TASK" | "GOMBOC_SCHEDULE" | "GITHUB_ACTION" | "IDE" | "MCP" | "PORTAL_DRIFT" | "CODE_AGENT";
            effect?: string;
            reports: {
                path?: string;
                branch?: string;
